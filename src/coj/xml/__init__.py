"""
coj.xml — export-only XML serialisation for corpus and dictionary.

from coj.xml.corpus_xml    import corpus_to_xml, corpus_to_xml_file, ...
from coj.xml.dictionary_xml import dictionary_to_xml, entry_to_str, ...
"""
